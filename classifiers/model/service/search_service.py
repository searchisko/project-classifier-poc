...
from classifiers.model.service.dependencies.doc2vec_wrapper import D2VWrapper
from classifiers.model.service.dependencies.scores_tuner import ScoreTuner
...
class RelevanceSearchService:
    ...
    default_model_dir = "persisted_model"
    service_meta = dict()
    ...
    def persist_trained_model(self, persist_dir=default_model_dir):
        ...
        self.d2v_wrapper.persist_trained_wrapper(persist_dir)
