...
label_content_mapping = {"fsw": "../data/content/fsw_content.csv"}
...
def get_labeled_content(df):
    ...
    # training_text_series = training_text_series.apply(lambda sentence_list: map(lambda sentence: token_split(sentence),
    #                                                                             sentence_list))
    #
    # training_text_series.apply(lambda doc_sen_list: np.append(sentence_container, doc_sen_list))
